...
usage () {
  echo "Usage: $0 [OPTION]..."
  echo "Run megaawesome's coding check(s)"
  echo ""
  echo "  -Y, --pylint [<basecommit>] Run pylint check on the entire megaawesome module or just files changed in basecommit (e.g. HEAD~1)"
